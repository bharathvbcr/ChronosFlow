...
object GenAiAssistCopy {
    ...
    fun taskAssistSourceLabel(source: com.ChronosFlow.VBCR.core.ai.TaskAssistSource): String = when (source) {
        com.ChronosFlow.VBCR.core.ai.TaskAssistSource.GEMINI_NANO -> "Gemini Nano"
        com.ChronosFlow.VBCR.core.ai.TaskAssistSource.CLOUD_GEMINI -> "Cloud Gemini"
        com.ChronosFlow.VBCR.core.ai.TaskAssistSource.LOCAL -> "Local"
    }

    fun routineAssistSourceLabel(source: com.ChronosFlow.VBCR.core.ai.RoutineAssistSource): String = when (source) {
        com.ChronosFlow.VBCR.core.ai.RoutineAssistSource.GEMINI_NANO -> "Gemini Nano"
        com.ChronosFlow.VBCR.core.ai.RoutineAssistSource.CLOUD_GEMINI -> "Cloud Gemini"
        com.ChronosFlow.VBCR.core.ai.RoutineAssistSource.LOCAL -> "Local"
    }

    fun focusAssistSourceLabel(source: com.ChronosFlow.VBCR.core.ai.FocusAssistSource): String = when (source) {
        com.ChronosFlow.VBCR.core.ai.FocusAssistSource.GEMINI_NANO -> "Gemini Nano"
        com.ChronosFlow.VBCR.core.ai.FocusAssistSource.CLOUD_GEMINI -> "Cloud Gemini"
        com.ChronosFlow.VBCR.core.ai.FocusAssistSource.LOCAL -> "Local"
    }
