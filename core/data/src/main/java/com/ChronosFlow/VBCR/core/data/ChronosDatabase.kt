...
import com.ChronosFlow.VBCR.core.data.util.Converters
...
abstract class ChronosDatabase : RoomDatabase() {
    ...
    abstract fun journalAttachmentDao(): JournalAttachmentDao
    ...
    companion object {
        ...
        val MIGRATION_21_22 = object : Migration(21, 22) {
            override fun migrate(db: SupportSQLiteDatabase) {
                // Share-to-task: track where imported tasks originated.
                db.execSQL("ALTER TABLE tasks ADD COLUMN `origin` TEXT")
        ...
        val MIGRATION_22_23 = object : Migration(22, 23) {
            override fun migrate(db: SupportSQLiteDatabase) {
                // Journal mood rating (1–5) per entry.
                db.execSQL("ALTER TABLE journal_entries ADD COLUMN `dayRating` INTEGER")
            }
        }

        val MIGRATION_23_24 = object : Migration(23, 24) {
            override fun migrate(db: SupportSQLiteDatabase) {
                // Timed journal points: optional minute-of-day timestamp (0–1439).
                db.execSQL("ALTER TABLE journal_entries ADD COLUMN `entryMinuteOfDay` INTEGER")
            }
        }

        val MIGRATION_24_25 = object : Migration(24, 25) {
            override fun migrate(db: SupportSQLiteDatabase) {
                // Journal image attachments stored as persisted content-URI references.
                db.execSQL(
                    """
