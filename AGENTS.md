...
This project is indexed by GitNexus as **ChronosFlow** (18365 symbols, 49484 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
