...
This project is indexed by GitNexus as **ChronosFlow** (15482 symbols, 40540 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
