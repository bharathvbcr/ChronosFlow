...
import com.ChronosFlow.VBCR.feature.daydial.delegate.encodePhases
...
internal fun DayDialFocusNotificationBridge(
        ...
        when (focusSession.status) {
            FocusExecutionStatus.RUNNING -> {
                if (serviceSessionId == null) {
                    ...
                    context.sendFocusServiceCommand(
                        action = com.ChronosFlow.VBCR.feature.focus.FocusService.ACTION_START,
                        timeLeft = timeLeft,
                    ...
                    context.sendFocusServiceCommand(
                        action = com.ChronosFlow.VBCR.feature.focus.FocusService.ACTION_RESUME,
                        timeLeft = timeLeft,
                        totalSeconds = totalSeconds,
            ...
            FocusExecutionStatus.PAUSED -> {
                ...
                if (focusSession.awaitingPhaseAdvance) {
                    ...
                    context.sendFocusServiceCommand(
                        action = com.ChronosFlow.VBCR.feature.focus.FocusService.ACTION_STOP,
                        timeLeft = timeLeft,
                        totalSeconds = totalSeconds,
                        sessionId = sessionId,
                        blockId = blockId,
                    ...
                    context.sendFocusServiceCommand(
                        action = com.ChronosFlow.VBCR.feature.focus.FocusService.ACTION_PAUSE,
                        timeLeft = timeLeft,
                        totalSeconds = totalSeconds,
                        sessionId = sessionId,
                        blockId = blockId
    ...
    LaunchedEffect(
        ...
        lastSyncedPlannedMinutes = focusSession.plannedDurationMinutes
        context.sendFocusServiceCommand(
            action = com.ChronosFlow.VBCR.feature.focus.FocusService.ACTION_EXTEND,
            timeLeft = timeLeft,
            totalSeconds = totalSeconds,
            sessionId = sessionId,
            blockId = blockId,
    ...
    LaunchedEffect(
        ...
        context.sendFocusServiceCommand(
            action = com.ChronosFlow.VBCR.feature.focus.FocusService.ACTION_SYNC,
            timeLeft = timeLeft,
            totalSeconds = totalSeconds,
            sessionId = sessionId,
            blockId = blockId
