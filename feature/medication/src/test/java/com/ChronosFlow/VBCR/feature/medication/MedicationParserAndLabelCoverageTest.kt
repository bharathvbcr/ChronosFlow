...
class MedicationParserAndLabelCoverageTest {
    private val FORM_SHEET_KT = Class.forName("com.ChronosFlow.VBCR.feature.medication.MedicationFormSheetKt")
    private val SCREEN_KT = Class.forName("com.ChronosFlow.VBCR.feature.medication.MedicationScreenKt")
    private val HINTS_CLASS = Class.forName("com.ChronosFlow.VBCR.feature.medication.MedicationModalAdaptiveHints")
